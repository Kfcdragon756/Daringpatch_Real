...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks_CSF", function(loc)
    LocalizationManager:add_localized_strings({
		...
		["menu_deck_liberator_1_desc_sc"] = "解锁##急救注射器##以供你使用。注射器会使用你的投掷物栏。使用急救注射器将立即回复##15##点耐力，并在接下来的##6##秒内每秒回复##1##点血量，玩家受到对血量的伤害将立即停止血量回复。\n注射器每##30##秒充能##1##次，每次击杀可以减少冷却时间##1##秒。\n\n你的闪避点数增加##5##。",
		["menu_deck_liberator_3_desc_sc"] = "急救注射器的回血效果延长##2##秒，\n\n当回血效果被打断，在剩余的持续时间内，你将获得##15%##的伤害抗性。",
