...
function CopDamage:damage_bullet(attack_data)
	...
	if not head and not self._char_tweak.no_headshot_add_mul and attack_data.weapon_unit:base().get_automatic_kills_to_head_shot_stacks then
		local add_head_shot_mul = attack_data.weapon_unit:base():get_automatic_kills_to_head_shot_stacks()
