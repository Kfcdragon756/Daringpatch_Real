...
--[[
tweak_data.armor_break_got_time = {
	0,
	0.22,
	0.23,
	0.24,
...
tweak_data.projectiles.dada_com.damage = 70
...
tweak_data.projectiles.sticky_grenade.range = 500
...
tweak_data.projectiles.wpn_gre_electric.player_damage = 1
...
local ve_fall_mult = 1.15  --普通
local ve_poison_fall_mult = 1.05  --毒
local ve_exp_fall_mult = 0.8  --爆炸
velocity_mult = 0.8
velocity = {
	'west_arrow',
	'crossbow_arrow',
...
for i, proj_id in ipairs(velocity) do
	tweak_data.projectiles[proj_id].launch_speed = 3500 * velocity_mult * ve_fall_mult
	...
	for i, proj_id in ipairs(velocity) do
		tweak_data.projectiles[proj_id].launch_speed = 3500 * velocity_mult * ve_poison_fall_mult
		tweak_data.projectiles[proj_id].adjust_z = tweak_data.projectiles[proj_id].launch_speed / 100 * velocity_mult
		tweak_data.projectiles[proj_id].mass_look_up_modifier = 0
	end
	velocity = {
	...
	for i, proj_id in ipairs(velocity) do
		tweak_data.projectiles[proj_id].launch_speed = 3500 * velocity_mult * ve_exp_fall_mult
		tweak_data.projectiles[proj_id].adjust_z = tweak_data.projectiles[proj_id].launch_speed / 100 * velocity_mult
		tweak_data.projectiles[proj_id].mass_look_up_modifier = 0
	end
...
for i, proj_id in ipairs(velocity) do
	tweak_data.projectiles[proj_id].launch_speed = 6500 * velocity_mult * ve_fall_mult
	tweak_data.projectiles[proj_id].adjust_z = tweak_data.projectiles[proj_id].launch_speed / 100 * velocity_mult
	tweak_data.projectiles[proj_id].mass_look_up_modifier = 0
end
	velocity = {
	...
	for i, proj_id in ipairs(velocity) do
		tweak_data.projectiles[proj_id].launch_speed = 6500 * velocity_mult * ve_poison_fall_mult
		tweak_data.projectiles[proj_id].adjust_z = tweak_data.projectiles[proj_id].launch_speed / 100 * velocity_mult
		tweak_data.projectiles[proj_id].mass_look_up_modifier = 0
	end
	velocity = {
	...
	for i, proj_id in ipairs(velocity) do
		tweak_data.projectiles[proj_id].launch_speed = 6500 * velocity_mult * ve_exp_fall_mult
		tweak_data.projectiles[proj_id].adjust_z = tweak_data.projectiles[proj_id].launch_speed / 100 * velocity_mult
		tweak_data.projectiles[proj_id].mass_look_up_modifier = 0
	end
...
for i, proj_id in ipairs(velocity) do
	tweak_data.projectiles[proj_id].launch_speed = 9500 * velocity_mult * ve_fall_mult
	tweak_data.projectiles[proj_id].adjust_z = tweak_data.projectiles[proj_id].launch_speed / 100 * velocity_mult
	tweak_data.projectiles[proj_id].mass_look_up_modifier = 0
end
	velocity = {
	...
	for i, proj_id in ipairs(velocity) do
		tweak_data.projectiles[proj_id].launch_speed = 9500 * velocity_mult * ve_poison_fall_mult
		tweak_data.projectiles[proj_id].adjust_z = tweak_data.projectiles[proj_id].launch_speed / 100 * velocity_mult
		tweak_data.projectiles[proj_id].mass_look_up_modifier = 0
	end
	velocity = {
	...
	for i, proj_id in ipairs(velocity) do
		tweak_data.projectiles[proj_id].launch_speed = 9500 * velocity_mult * ve_exp_fall_mult
		tweak_data.projectiles[proj_id].adjust_z = tweak_data.projectiles[proj_id].launch_speed / 100 * velocity_mult
		tweak_data.projectiles[proj_id].mass_look_up_modifier = 0
	end
