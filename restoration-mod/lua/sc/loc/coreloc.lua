...
-- I'm sorry to do these bullshit, but this is because "Always load english loc" would result in an serious incompatible issue with my(LR_Daring) mod for Resmod, while I can't do nothing in my side
